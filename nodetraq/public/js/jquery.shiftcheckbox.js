...
(function ($) {
    ...
    function update_context_selector(row) {
        var parent_row = $(row).parent().parent();

        if($(row).attr('checked')) {
            parent_row.addClass('context-menu-selection');
        } else {
            parent_row.removeClass('context-menu-selection');
        }
    }
})(jQuery);